defmodule SymphonyElixir.StatusDashboard do
  ...
  defp format_running_summary(running_entry, running_event_width) do
    ...
    pid = format_cell(running_entry.runtime_pid || "n/a", @running_pid_width)
    ...
    status_color =
      case event do
        :none -> @ansi_red
        "thread/tokenUsage/updated" -> @ansi_yellow
        "turn/started" -> @ansi_green
  ...
  def humanize_runtime_message(nil), do: "waiting for events"
  ...
  defp humanize_runtime_event(:malformed, _message, _payload), do: "malformed JSON event"
