defmodule SymphonyElixir.SSHTest do
  ...
  test "start_port/3 supports reverse port forwarding" do
    ...
    trace = File.read!(trace_file)
    assert trace =~ "-T -p 2200"
    assert trace =~ "-R 43123:127.0.0.1:43123"
  ...
  defp wait_for_trace!(trace_file, attempts \\ 40)
