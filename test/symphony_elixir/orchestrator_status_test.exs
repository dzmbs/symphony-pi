defmodule SymphonyElixir.OrchestratorStatusTest do
  ...
  test "orchestrator snapshot reflects last runtime update and session id" do
    ...
    issue = %Issue{
      ...
      identifier: "MT-188",
      title: "Snapshot test",
      description: "Capture runtime state",
      state: "In Progress",
  ...
  test "orchestrator snapshot tracks runtime totals and runtime pid" do
    ...
    snapshot = GenServer.call(pid, :snapshot)
    assert %{running: [snapshot_entry]} = snapshot
    assert snapshot_entry.runtime_pid == "4242"
  ...
  test "orchestrator snapshot tracks runtime rate-limit payloads" do
    ...
    issue = %Issue{
      ...
      description: "Capture runtime rate limit state",
      state: "In Progress",
  ...
  test "status dashboard renders last runtime message in EVENT column" do
    row =
  ...
  test "status dashboard strips ANSI and control bytes from last runtime message" do
    payload =
      "cmd: " <>
        <<27>> <>
        "[31mRED" <>
  ...
  test "status dashboard humanizes Pi and generic runtime events" do
    event_cases = [
  ...
  test "status dashboard unwraps nested runtime payload envelopes" do
    wrapped = %{
      event: :notification,
      message: %{
        payload: %{
  ...
  test "status dashboard formats auto-approval updates from runtime" do
    message = %{
  ...
  test "status dashboard formats auto-answered tool input updates from runtime" do
    message = %{
